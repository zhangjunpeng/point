...
public class DownloadUtils {
    ...
    public DownloadUtils(Context context, AppVersionModel model, String name) {
        this.mContext = context;
        this.model = model;
        downloadAPK(model.getList().get(0).getDownloadurl(), name);
        this.name = name;
    }
...
//        request.setDescription("新版***下载中...");
    ...
    private void installAPK() {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            Uri apkUri = FileProvider.getUriForFile(mContext, "com.zjdx.point.fileprovider", file);
